...
body.light{
  ...
  --text:#101815;
  --muted:#5c6965;
  --border:rgba(10,30,20,.12);
  --shadow:0 25px 70px rgba(30,60,50,.12);
}
...
body.light .navbar{
  background:rgba(243,248,246,.82);
}
...
.btn.primary:hover{
  ...
  box-shadow:0 12px 30px rgba(67,245,154,.2);
}
...
.profile-ring{
  ...
  box-shadow:0 0 70px rgba(67,245,154,.13);
}
...
.terminal{
  ...
  width:285px;
  background:#080d12;
  border:1px solid rgba(67,245,154,.22);
  border-radius:13px;
  padding:17px;
...
.fact:hover{
  ...
  border-color:rgba(67,245,154,.3);
}
...
.tool-card:hover{
  ...
  border-color:rgba(67,245,154,.4);
  box-shadow:var(--shadow);
}
...
.github-box{
  max-width:1120px;
  padding:45px;
  border:1px solid rgba(67,245,154,.18);
  border-radius:20px;
  background:
    radial-gradient(
      circle at 100% 0%,
...
.timeline-dot{
  ...
  left:-38px;
  top:7px;
  box-shadow:0 0 16px rgba(67,245,154,.5);
}
